    ...
    <>
      ...
      >
        ...
        {/* <View style={styles.middleContainer}>
          ...
          <Pressable
            style={[
              styles.fasterDeliveryContainer,
              isfasterBlack && { borderColor: "black" },
            ]}
          ...
          >
            ...
            <View style={{ marginLeft: 15 }}>
              <View style={styles.fasterDeliverySubContainer}>
                ...
                <Text style={styles.fasterTimeTextStyle}>+{"Rs"}2.99</Text>
              </View>
              <Text style={styles.timeTextStyle}>
                25-40 min(s) • Delivered directly to you
              </Text>
            </View>
          </Pressable>
          <Pressable
            style={[
              styles.standardDeliveryContainer,
              isstandardBlack && { borderColor: "#e2e2e2" },
            ]}
          ...
          <View style={{ marginTop: 20 }}>
            ...
            <View style={styles.resturantInformationContainer}>
              <Image
                ...
                style={styles.resturantImageStyle}
              />
              <View>
                <View style={styles.resturantInformationSubContainer}>
                  <Text style={styles.resturantNameTextStyle}>
                    {item.resturantName}
                  </Text>
                  <Text style={styles.resturantAddressTextStyle}>
                    ({truncate(item.resturantAddress, 14)})
                  </Text>
                </View>
        ...
        {/* <View style={styles.giftTextContainer}>
          ...
          <View style={{ marginLeft: 20 }}>
            ...
            <Text style={styles.addReceiptTextStyle}>
        ...
        {/* <View
          style={[styles.borderStyle, { marginLeft: 60, marginRight: 15 }]}
        /> */}
        ...
        <View style={styles.creditCardDetailsContainer}>
          <Image
            ...
            style={styles.creditCardImageStyle}
          />
          <View style={styles.iconContainer}>
            <MaterialIcons
              name="keyboard-arrow-right"
        ...
        <View style={styles.bottomDescriptionContainer}>
          <Text style={styles.bottomDescriptionTextStyle}>
            ...
            responsibility for it once it's delivered. Orders containing alcohol
            or other restricted items may not be eligible for leave at door and
            will be returned to the shop if you are not available.
          </Text>
        </View>
        <Pressable
