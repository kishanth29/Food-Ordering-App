  ...
  const addItemtoFirebase = (item) =>
    dispatch({
      ...
      payload: {
        ...
        resturantImage: restimage,
        resturantAddress: restAddress,
        quantity: quantity,
        total: Number(getTotal()) + Number(dessertPrice),
      },
    });
    ...
    <>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        {image ? (
          <Image
            source={{ uri: image }}
            style={[styles.imageStyle, notfood && { resizeMode: "contain" }]}
          />
        ) : (
          <Image
            source={{ uri: restimage }}
        ...
        {information && (
          <View style={styles.menuDetailsContainer}>
            <MenuDessertDetails
              ...
              setDessertPrice={setDessertPrice}
            />
          </View>
        )}
        {instruction && (
          ...
          >
            <View style={styles.instructionSubContainer}>
              ...
              <View style={styles.instructionTextInputContainer}>
                <TextInput
                  style={styles.instructionTextInputStyle}
        ...
        {!groceries ? (
          <View style={styles.meunItemsContainer}>
            <MenuItems
              foods={foods}
              restName={route.params.restName}
              image={route.params.restimage}
              address={route.params.restAddress}
              marginLeft={22}
              information={false}
              instruction={false}
            />
      ...
      <Pressable
        ...
        onPress={() => addItemtoFirebase(food)}
      >
