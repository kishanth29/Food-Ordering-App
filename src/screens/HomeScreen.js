...
const groceries = [
    ...
    },
    {
        ...
        image: "https://tb-static.uber.com/prod/image-proc/processed_images/b409ed455208de8b670caa1a0db76410/719c6bd2757b08684c0faae44d43159d.jpeg",
        text: "Gopuff",
        address: "",
        rating: "4.8",
        reviews: "200+",
...
function HomeScreen() {
    ...
    const [cities1, setCities1] = useState("Boston");
    ...
    return (
        <>
            <View style={styles.headerContainer}>
                <View style={{ marginLeft: 15 }}>
                    ...
                    <View style={styles.headerSubContainer}>
                        <Text style={{ fontWeight: "500" }}>Map location</Text>
            ...
            <ScrollView vertical showsVerticalScrollIndicator={false}>
                <SearchBar cityHandler={setCity} backgroundColor={"#eee"} marginTop={0} marginRight={0} left={0} width={370} alignSelf="center" height={50} placeHolder={"Food, groceries, drinks, etc"} />
                <CategoriesItems />
                <View style={[styles.contentContainer, { marginTop: 12 }]}>
                    <Text style={[styles.textStyle, { marginTop: 10 }]}>Get groceries and more</Text>
                    <View style={{ marginRight: 15 }}>
                ...
                <View style={styles.contentContainer}>
                    <View style={{ flexDirection: "row" }}>
                        <Text style={[styles.textStyle, { marginTop: 15 }]}>Family favourites</Text>
                        <Text style={styles.seeAllTextStyle}>See all</Text>
                    </View>
                    <FlatList horizontal showsHorizontalScrollIndicator={false} data={resturantData1} renderItem={({ item }) => <ResturantDetail resturantData={item} isList="true" discount={false} marginTop={10} left={0} top={8} />} />
                </View>
                <View style={styles.popularResturantsDataContainer}>
                    <View style={{ flexDirection: "row" }}>
                        <Text style={[styles.textStyle, { marginTop: 15 }]}>Popular near you</Text>
                        <Text style={[styles.seeAllTextStyle, { fontWeight: "500" }]}>See all</Text>
                    </View>
                ...
                <View style={styles.contentContainer}>
                    <Text style={[styles.textStyle, { marginTop: 15 }]}>Refreshing drinks</Text>
                    <FlatList horizontal showsHorizontalScrollIndicator={false} data={drinks} renderItem={({ item }) => <HomeItems items={item} marginBottom={15} restName={homeresturant.text} image={homeresturant.image} address={homeresturant.address} notfood={true} groceries={true} />} />
                </View>
                <View style={{ marginTop: 8 }}>
                    <Text style={styles.textStyle}>Frozen desserts</Text>
                    <FlatList horizontal showsHorizontalScrollIndicator={false} data={desserts} renderItem={({ item }) => <HomeItems items={item} marginBottom={15} restName={homeresturant.text} image={homeresturant.image} address={homeresturant.address} notfood={true} groceries={true} />} />
                </View>
                <View style={{ marginTop: 8 }}>
                    <Text style={styles.textStyle}>Chocolates</Text>
                    <FlatList horizontal showsHorizontalScrollIndicator={false} data={chocolates} renderItem={({ item }) => <HomeItems items={item} marginBottom={15} restName={homeresturant.text} image={homeresturant.image} address={homeresturant.address} notfood={true} groceries={true} />} />
                </View>
                <View style={{ marginTop: 8 }}>
                    <Text style={styles.textStyle}>Snacks</Text>
                    <FlatList horizontal showsHorizontalScrollIndicator={false} data={snacks} renderItem={({ item }) => <HomeItems items={item} marginBottom={15} restName={homeresturant.text} image={homeresturant.image} address={homeresturant.address} notfood={true} groceries={true} />} />
                </View>
