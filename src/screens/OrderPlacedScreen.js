    ...
    return (
        <>
            ...
            <View style={{ marginTop: 50 }}>
                ...
                <Text style={[styles.titleTextStyle, { marginTop: 5 }]}>Show your support</Text>
                <Text style={styles.titleTextStyle}>with a tip</Text>
                <View style={styles.descriptionTextContainer}>
                    <Text style={styles.descriptionTextStyle}>100% of your tip goes to your courier. Tips are based on your order total of {"\u00A3"}{getTotal} before any discounts or promotions.</Text>
                </View>
                <View style={styles.tipContainer}>
                    <View style={styles.tipSubContainer}>
                        <Image source={require("../../assets/images/star.png")} style={styles.imageStyle} />
                        <Text style={styles.textStyle}>Cheers to you</Text>
                    </View>
                    <Pressable style={[styles.tipTextContainer, tipPrice === 2 && { backgroundColor: "black" }]} onPress={() => setTipPrice(2)}>
                        <Text style={[styles.tipTextStyle, tipPrice === 2 && { color: "white" }]}>{"\u00A3"}2.00</Text>
                    </Pressable>
                </View>
                <View style={styles.tipContainer}>
                    <View style={styles.tipSubContainer}>
                        <Image source={require("../../assets/images/yellowstar.png")} style={styles.imageStyle} />
                        <Text style={styles.textStyle}>You 're great</Text>
                    </View>
                    <Pressable style={[styles.tipTextContainer, tipPrice === 3 && { backgroundColor: "black" }]} onPress={() => setTipPrice(3)}>
                        <Text style={[styles.tipTextStyle, tipPrice === 3 && { color: "white" }]}>{"\u00A3"}3.00</Text>
                    </Pressable>
                </View>
                <View style={styles.tipContainer}>
                    <View style={styles.tipSubContainer}>
                        <Image source={require("../../assets/images/blackstar.png")} style={styles.imageStyle} />
                        <Text style={styles.textStyle}>Thank you so much</Text>
                    </View>
                    <Pressable style={[styles.tipTextContainer, tipPrice === 4 && { backgroundColor: "black" }]} onPress={() => setTipPrice(4)}>
                        <Text style={[styles.tipTextStyle, tipPrice === 4 && { color: "white" }]}>{"\u00A3"}4.00</Text>
                    </Pressable>
                </View>
                <View style={styles.borderStyle} />
                <View style={styles.bottomContainer}>
                    <Text style={{ fontSize: 17 }}>Your tip: </Text>
                    <Text style={styles.bottomTextStyle}>{"\u00A3"}{tipPrice}.00</Text>
                </View>
