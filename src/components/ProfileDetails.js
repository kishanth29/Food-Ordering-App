        ...
        <View>
            ...
            <View style={[styles.container, { marginTop: 35 }]}>
                ...
                <View>
                    ...
                    <Text style={styles.descriptionTextStyle}>Manage a family profile</Text>
                </View>
            </View>
            <View style={[styles.container, { marginTop: 35 }]}>
                ...
                <View>
                    ...
                    <Text style={styles.descriptionTextStyle}>Make work meals quicker and easier</Text>
                </View>
            </View>
            <View style={[styles.container, { marginTop: 35 }]}>
            ...
            <View style={[styles.container, { marginTop: 35 }]}>
                ...
                <View>
                    ...
                    <Text style={styles.descriptionTextStyle}>Get ₹100 off your order</Text>
                </View>
            </View>
            <View style={[styles.container, { marginTop: 35 }]}>
